...
const addproductToDB = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const productData = req.body;
    const result = yield product_service_1.productServices.addproduct(productData);
...
const updateproduct = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_service_1.productServices.updateproduct(id, updateData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const getAllproducts = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.mapReqQuerysProperty)(req.query, product_constant_1.filterableFields);
    console.log('filters:', filters);
    const result = yield product_service_1.productServices.getAllproducts(filters);
