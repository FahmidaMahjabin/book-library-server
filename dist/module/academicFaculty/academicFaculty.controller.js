...
const createAcademicFaculty = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicFaculty_service_1.academicFacultyService.createAcademicFacultyToBD(title);
...
const getAllFaculty = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_service_1.academicFacultyService.getAllFacultyFromDb();
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
